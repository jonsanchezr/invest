          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Propiedades <small>Listado</small></h3>
              </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <ul class="nav navbar-right panel_toolbox">
                      <li>
                        <button type="button" class="btn btn-round btn-default"><a href="/admin/estates/create"><i class="fa fa-plus"></i> Nuevo</a></button>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$estate->state}}</td>
                          <td>${{$estate->amount}}.00</td>
                          <td>
                            <a href="/details/{{$estate->id}}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="/admin/estates/{{$estate->id}}/edit" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="/admin/estates/{{$estate->id}}/delete" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
