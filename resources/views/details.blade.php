...
<img class="img-fluid" src="/assets/img/featured/img-{{rand(1, 6)}}.jpg" alt="">
</div>
<span class="price">${{$estate->amount}}</span>
</div>
<div class="item">
<div class="product-img">
<img class="img-fluid" src="/assets/img/featured/img-{{rand(1, 6)}}.jpg" alt="">
...
<span><a href="#"><i class="lni-map-marker"></i> {{$estate->address}}, Alicante</a></span>
