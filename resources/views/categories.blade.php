...
<div class="top-bar">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-5 col-xs-12">
                    ...
                    <ul class="list-inline">
                        ...
                        <li><i class="lni-envelope"></i> <a href="/" class="__cf_email__" data-cfemail="5e2d2b2e2e312c2a1e39333f3732703d3133">[email&#160;protected]</a></li>
                    </ul>
                </div>
                <div class="col-lg-5 col-md-7 col-xs-12">
                    ...
                    <div class="header-top-right float-right">
                        <a href="/clients/login" class="header-top-button"><i class="lni-lock"></i> Log In</a> |
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top scrolling-navbar">
        ...
        <ul class="mobile-menu">
            ...
            <li>
                <a class="active" href="/categories">Categorias</a>
            </li>
            <li>
                <a href="/about-us">Categorias</a>
            </li>
            <li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="featured-box">
                <figure>
                    ...
                    <a href="#"><img class="img-fluid" src="assets/img/featured/img-{{rand(1, 6)}}.jpg" alt="" style="height: 256px;width: 100%;"></a>
                </figure>
                <div class="feature-content">
                    <div class="product">
                        <a href="#">{{$estate->state}}</a>
                    </div>
                    <h4><a href="/details/{{$estate->id}}">{{$estate->title}}</a></h4>
                    <div class="meta-tag">
                        <span>
                            <a href="#"><i class="lni-map-marker"></i> {{$estate->address}}, Alicante</a>
                        </span>
                    </div>
                    <div class="row">
                    ...
                    <div class="listing-bottom">
                        <h3 class="price float-left">${{$estate->amount}}.00</h3>
                        <a href="/details/{{$estate->id}}" class="btn btn-common float-right">Invertir</a>
                    </div>
                </div>
            </div>
        </div>
